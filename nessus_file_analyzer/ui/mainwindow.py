...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.checkBox_debug_data_scan.setGeometry(QtCore.QRect(10, 30, 121, 20))
        ...
        self.checkBox_debug_data_host.setGeometry(QtCore.QRect(10, 30, 121, 20))
        ...
        self.checkBox_debug_data_vulnerabilities.setGeometry(QtCore.QRect(10, 30, 121, 20))
        ...
        self.checkBox_vulnerabilities_none_filter_out.setGeometry(QtCore.QRect(10, 50, 161, 20))
        ...
        self.checkBox_debug_data_noncompliance.setGeometry(QtCore.QRect(10, 30, 121, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox_vulnerabilities_none_filter_out.setToolTip(_translate("MainWindow", "<html><head/><body><p>Mark this checkbox if you want to automatically filter out plugins results with None Risk Factor and see only these which Risk Factor is equal Low, Medium, High or Critical.</p><p><span style=\" font-style:italic;\">Note: Plugins results with None Risk Factor are not removed from report, to see them use filter in column Risk Factor.</span></p></body></html>"))
        ...
        self.pushButton_start.setToolTip(_translate("MainWindow", "<html><head/><body><p>Click to <span style=\" font-weight:600;\">start </span>conversion of selected *.nessus files.</p></body></html>"))
