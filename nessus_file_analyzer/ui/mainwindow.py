...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tab_standard_reports = QtWidgets.QWidget()
        self.tab_standard_reports.setObjectName("tab_standard_reports")
        self.label_report_type = QtWidgets.QLabel(self.tab_standard_reports)
        self.label_report_type.setGeometry(QtCore.QRect(10, 10, 201, 16))
        self.label_report_type.setObjectName("label_report_type")
        self.checkBox_report_scan = QtWidgets.QCheckBox(self.tab_standard_reports)
        ...
        self.checkBox_report_host = QtWidgets.QCheckBox(self.tab_standard_reports)
        ...
        self.checkBox_report_vulnerabilities = QtWidgets.QCheckBox(self.tab_standard_reports)
        ...
        self.checkBox_report_noncompliance = QtWidgets.QCheckBox(self.tab_standard_reports)
        ...
        self.groupBox_options_scan = QtWidgets.QGroupBox(self.tab_standard_reports)
        ...
        self.groupBox_options_host = QtWidgets.QGroupBox(self.tab_standard_reports)
        ...
        self.groupBox_options_vulnerabilities = QtWidgets.QGroupBox(self.tab_standard_reports)
        ...
        self.groupBox_options_noncompliance = QtWidgets.QGroupBox(self.tab_standard_reports)
        ...
        self.tabWidget_settings.addTab(self.tab_standard_reports, "")
        self.tab_advanced_reports = QtWidgets.QWidget()
        self.tab_advanced_reports.setObjectName("tab_advanced_reports")
        self.verticalLayout_tab_advanced_reports = QtWidgets.QVBoxLayout(self.tab_advanced_reports)
        self.verticalLayout_tab_advanced_reports.setObjectName("verticalLayout_tab_advanced_reports")
        self.label_advanced_reports = QtWidgets.QLabel(self.tab_advanced_reports)
        self.label_advanced_reports.setObjectName("label_advanced_reports")
        self.verticalLayout_tab_advanced_reports.addWidget(self.label_advanced_reports)
        self.scrollArea_advanced_plugins = QtWidgets.QScrollArea(self.tab_advanced_reports)
        self.scrollArea_advanced_plugins.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.scrollArea_advanced_plugins.setWidgetResizable(True)
        self.scrollArea_advanced_plugins.setObjectName("scrollArea_advanced_plugins")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 680, 140))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.verticalLayout_advanced_plugins = QtWidgets.QVBoxLayout(self.scrollAreaWidgetContents)
        self.verticalLayout_advanced_plugins.setObjectName("verticalLayout_advanced_plugins")
        self.label_no_plugins = QtWidgets.QLabel(self.scrollAreaWidgetContents)
        self.label_no_plugins.setAlignment(QtCore.Qt.AlignCenter)
        self.label_no_plugins.setObjectName("label_no_plugins")
        self.verticalLayout_advanced_plugins.addWidget(self.label_no_plugins)
        spacerItem = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_advanced_plugins.addItem(spacerItem)
        self.scrollArea_advanced_plugins.setWidget(self.scrollAreaWidgetContents)
        self.verticalLayout_tab_advanced_reports.addWidget(self.scrollArea_advanced_plugins)
        self.tabWidget_settings.addTab(self.tab_advanced_reports, "")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget_settings.setTabText(self.tabWidget_settings.indexOf(self.tab_standard_reports), _translate("MainWindow", "Standard reports"))
        self.label_advanced_reports.setText(_translate("MainWindow", "Select advanced reports to generate:"))
        self.label_no_plugins.setText(_translate("MainWindow", "No advanced reports available."))
        self.tabWidget_settings.setTabText(self.tabWidget_settings.indexOf(self.tab_advanced_reports), _translate("MainWindow", "Advanced reports"))
